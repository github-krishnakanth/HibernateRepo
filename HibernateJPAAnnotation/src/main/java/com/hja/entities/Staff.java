package com.hja.entities;
// Generated Apr 5, 2019 1:35:36 PM by Hibernate Tools 5.0.6.Final
...
@Entity
@Table(name = "staff", catalog = "christydb")
public class Staff implements java.io.Serializable {
	private static final long serialVersionUID = 5911493978765008716L;
	...
	@Column(name = "staff_first_nm", length = 30)
	...
	@Column(name = "staff_last_nm", length = 30)
